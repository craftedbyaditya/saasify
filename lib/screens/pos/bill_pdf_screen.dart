...
class BillPdfGenerator {
  ...
  pw.Row _buildPriceRow(String label, String price) {
    return pw.Row(
      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      children: [
  ...
  pw.Row _buildSummaryRow(String label, String price, {bool isBold = false}) {
    return pw.Row(
      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      children: [
        pw.Text(label, style: const pw.TextStyle(fontSize: 12)),
  ...
  Future<Map<String, String>> _getBusinessDetails() async {
    ...
    return {'businessName': businessName ?? '', 'phone': phone ?? ''};
  }
}
